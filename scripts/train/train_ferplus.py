...
def main() -> None:
    """Main training function: Parse arguments, run FER+ training, and plot results."""
    parser = argparse.ArgumentParser(description="Train ResNet on FER+ data.")
    parser.add_argument("--data-dir", default="data/ferplus")
    parser.add_argument("--output-dir", default="outputs/ferplus/ferplus_best_generalization")
