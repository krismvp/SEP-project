...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Train or fine-tune ResNet on RAF-DB."
    )
    ...
    parser.add_argument("--output-dir", default="outputs/finetune/raf_best_generalization", help="Directory to save checkpoints and curves")
    ...
    parser.add_argument("--lr", type=float, default=3e-4, help="Learning rate for head layers")
    ...
    parser.add_argument("--weighted-sampler", dest="weighted_sampler", action="store_true", help="Use weighted sampling for class imbalance")
    parser.add_argument("--no-weighted-sampler", dest="weighted_sampler", action="store_false", help="Disable weighted sampling for class imbalance")
    ...
    parser.add_argument("--class-weight-power", type=float, default=0.2, help="Power scaling for class weights")
